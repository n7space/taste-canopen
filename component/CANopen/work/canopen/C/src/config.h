...
/* Define to 1 if ECSS bus redundancy support is disabled. */
/* #undef LELY_NO_CO_ECSS_REDUNDANCY */
...
#define PACKAGE_STRING "Lely core libraries 3.5.0"
